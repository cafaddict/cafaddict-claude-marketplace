...
### 디렉토리가 없는 경우
"아직 시작되지 않았습니다. `/wf:0`으로 0단계(문제 정의)부터 시작하세요." 라고 안내한다.
...
| 단계 | 스킬 | 파일 | 상태 |
|------|------|------|------|
| 0. 문제 정의 | `/wf:0` | `0-problem-definition.md` | 완료/미완료 |
| 1. 목표 정의 | `/wf:1` | `1-goals.md` | 완료/미완료 |
| 2. 요구사항 정리 | `/wf:2` | `2-requirements.md` | 완료/미완료 |
| 3. 설계 | `/wf:3` | `3-design.md` | 완료/미완료 |
| 4. 작업 분해 | `/wf:4` | `4-task-breakdown.md` | 완료/미완료 |
| 5. MVP 구현 | `/wf:5` | `5-mvp.md` | 완료/미완료 |
| 6. 검증 | `/wf:6` | `6-verification.md` | 완료/미완료 |
| 7. 마무리 | `/wf:7` | `7-wrap-up.md` | 완료/미완료 |

3. 다음 진행할 단계를 안내한다: "다음 단계: `/wf:N`으로 진행하세요."
...
3. "새 이터레이션 v1이 시작되었습니다. `/wf:0`으로 시작하세요." 라고 안내한다.
